      ...
      <Container style={{ marginLeft: '3%' }}>
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          <Nav className="me-auto">
            ...
            <Link className="nav-link" href="/Cryptids" style={{ marginLeft: '200px', fontFamily: 'courier', fontSize: '30px', fontWeight: 'bold', color: 'rgb(220, 88, 40)', WebkitTextStroke: '1px', WebkitTextStrokeColor: 'black' }}>
              Explore
            </Link>
